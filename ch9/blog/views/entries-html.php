<?php
//complete code for views/entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/entries-html.php needs $entries' );
}
...
//$entry will be a StdClass object with entry_id, title, image and intro
