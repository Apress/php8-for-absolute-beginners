<?php
//complete code for views/admin/secure-entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/secure-entries-html.php needs $entries' );
}
...
while ( $entry = $entries->fetchObject() ) {
    $href  = "secureadmin.php?page=secureeditor&amp;id=$entry->entry_id";
