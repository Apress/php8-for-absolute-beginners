<?php
//complete code for views/admin/new-session-entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/new-session-entries-html.php needs $entries' );
}
...
while ( $entry = $entries->fetchObject() ) {
    $href  = "newsessionadmin.php?page=newsessioneditor&amp;id=$entry->entry_id";
