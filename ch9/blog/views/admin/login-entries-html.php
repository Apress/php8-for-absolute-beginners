<?php
//complete code for views/admin/login-entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/login-entries-html.php needs $entries' );
}
...
while ( $entry = $entries->fetchObject() ) {
    $href  = "loginadmin.php?page=logineditor&amp;id=$entry->entry_id";
