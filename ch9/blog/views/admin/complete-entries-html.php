<?php
//complete code for views/admin/complete-entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/complete-entries-html.php needs $entries' );
}
...
while ( $entry = $entries->fetchObject() ) {
    $href  = "completeadmin.php?page=completeeditor&amp;id=$entry->entry_id";
