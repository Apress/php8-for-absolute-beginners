<?php
//complete code for views/search-entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/search-entries-html.php needs $entries' );
}
...
while ( $entry = $entries->fetchObject() ) {
    $href  = "searchindex.php?page=searchblog&amp;id=$entry->entry_id";
