<?php
//complete code for views/admin/newest-entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/admin/newest-entries-html.php needs $entries' );
}
...
while ( $entry = $entries->fetchObject() ) {
    $href  = "newadmin.php?page=newesteditor&amp;id=$entry->entry_id";
