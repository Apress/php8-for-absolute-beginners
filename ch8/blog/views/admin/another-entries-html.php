<?php
//complete code for views/admin/another-entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/admin/another-entries-html.php needs $entries' );
}
...
while ( $entry = $entries->fetchObject() ) {
    $href  = "anotheradmin.php?page=anothereditor&amp;id=$entry->entry_id";
