<?php
//complete code for views/updated-entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/updated-entries-html.php needs $entries' );
}
...
while ( $entry = $entries->fetchObject() ) {
    $href  = "updatedindex.php?page=updatedblog&amp;id=$entry->entry_id";
