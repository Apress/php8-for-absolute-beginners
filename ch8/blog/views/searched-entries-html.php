<?php
//complete code for views/searched-entries-html.php
$entriesFound = isset( $entries );
if ( $entriesFound === false ) {
    trigger_error( 'views/searched-entries-html.php needs $entries' );
}
...
while ( $entry = $entries->fetchObject() ) {
    $href  = "searchedindex.php?page=searchedblog&amp;id=$entry->entry_id";
